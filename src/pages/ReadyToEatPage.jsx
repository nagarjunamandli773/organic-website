...
export const ReadyToEatPage = () => {
  ...
  const [selectedSubCat, setSelectedSubCat] = useState('All Ready to Eat');
  ...
  const handleClearFilters = () => {
    setSelectedSubCat('All Ready to Eat');
  ...
  const filteredProducts = useMemo(() => {
    return READY_TO_EAT_PRODUCTS.filter(p => {
      // Subcategory filter
      if (selectedSubCat !== 'All Ready to Eat' && p.subCategory !== selectedSubCat && p.type !== selectedSubCat) {
        return false;
      }
  ...
  const scrollToProducts = () => {
    const el = document.getElementById('rte-products-anchor');
  ...
  return (
    <div className="fruits-category-page">
      <div className="main-content-container">
          ...
          <div className="fruits-header-left">
            <div className="breadcrumbs-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <ChevronRight size={13} className="crumb-chevron" />
                <span className="current-crumb">Ready to Eat</span>
              </div>
            </div>

            <h1 className="fruits-page-title">Organic Ready to Eat</h1>

            <p className="fruits-page-description">
              Enjoy the goodness of nature with our wide range of fresh, organic ready to eat meals. Handpicked for quality, freshness, and nutrition.
            </p>
          ...
          <div className="fruits-hero-card">
            ...
            <div className="banner-content">
              ...
              <p className="banner-subtitle">
                Handpicked Organic Ready to Eat Meals for a Healthy You
              </p>
        ...
        <div className="category-layout" id="rte-products-anchor">
              ...
              <div className="filter-group">
                ...
                {openSections.categories && (
                  <div className="filter-group-body">
                    {READY_TO_EAT_CATEGORIES.map((cat) => {
                      const catName = cat.name;
                      const isSelected = selectedSubCat === catName || (selectedSubCat === 'All Ready to Eat' && cat.id === 'all');
                      return (
                        <label 
                          key={cat.id} 
          ...
          <div className="product-listing-content">
            ...
            <ProductGrid
              ...
              emptyMessage="No organic ready to eat items match your selected criteria."
            />
