...
import { 
  ChevronRight, ArrowLeft, ArrowRight, Leaf, ChevronDown, ChevronUp, RefreshCw 
} from 'lucide-react';
...
export const SanitaryPage = () => {
  ...
  const [selectedSubCat, setSelectedSubCat] = useState('All Sanitary Care');
  ...
  const handleClearFilters = () => {
    setSelectedSubCat('All Sanitary Care');
  ...
  const filteredProducts = useMemo(() => {
    return SANITARY_PRODUCTS.filter(p => {
      // Subcategory filter
      if (selectedSubCat !== 'All Sanitary Care' && p.subCategory !== selectedSubCat && p.type !== selectedSubCat) {
        return false;
      }
      ...
      if (selectedCerts.length > 0) {
        const matchCert = selectedCerts.some(cert => 
          ...
          (cert === 'Chemical Free' && p.certification && p.certification.toLowerCase().includes('organic'))
        );
  ...
  const scrollToProducts = () => {
    const el = document.getElementById('sanitary-products-anchor');
  ...
  return (
    <div className="fruits-category-page">
      <div className="main-content-container">
          ...
          <div className="fruits-header-left">
            <div className="breadcrumbs-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <ChevronRight size={13} className="crumb-chevron" />
                <span className="current-crumb">Sanitary Care</span>
              </div>
            </div>

            <h1 className="fruits-page-title">Organic Sanitary Care</h1>

            <p className="fruits-page-description">
              100% Certified Organic Cotton Pads, Medical-Grade Menstrual Cups, Herbal Intimate Washes, & Eco Disposal Bags. 0% Chlorine, Dyes, or Synthetics.
            </p>
          ...
          <div className="fruits-hero-card">
            ...
            <div className="banner-content">
              <h2 className="banner-title">
                Pure Comfort, Gentle on You & The Planet
              </h2>
              <p className="banner-subtitle">
                100% Plastic-Free, Biodegradable & Dermatologist Tested Care
              </p>
        ...
        <div className="category-layout" id="sanitary-products-anchor">
              ...
              <div className="filter-group">
                ...
                {openSections.categories && (
                  <div className="filter-group-body">
                    {SANITARY_CATEGORIES.map((cat) => {
                      const catName = cat.name;
                      const isSelected = selectedSubCat === catName || (selectedSubCat === 'All Sanitary Care' && cat.id === 'all');
                      return (
                        <label 
                          key={cat.id} 
                  ...
                  <div className="filter-group-body">
                    {['100% Organic', 'Chemical Free'].map((cert) => (
                      ...
                      >
                        ...
                        />
                        <span className="checkbox-custom"></span>
                        <span className="checkbox-label" style={{ fontWeight: selectedCerts.includes(cert) ? 600 : 400, color: selectedCerts.includes(cert) ? '#165b2e' : '#334155' }}>
                          {cert}
                        </span>
                      </label>
                    ))}
          ...
          <div className="product-listing-content">
            ...
            <ProductGrid
              ...
              emptyMessage="No organic sanitary care products found matching your current filters."
            />
